...
<tbody>
    <%      int valid = 0;
                        ...
                        if (result != null && result.get() != null) {
                            java.util.List<me.prettyprint.hector.api.beans.Row<String, String, String>> list = result.get().getList();
                                for (me.prettyprint.hector.api.beans.Row<String, String, String> row : list) {
                                        String[] str1 = row.getColumnSlice().getColumns().get(1).getValue().split("-");
                                         String keyspace = str1[0];
                                            ...
                                            java.util.List<me.prettyprint.hector.api.beans.Row<String, String, String>> list1 = result1.get().getList();
                                                for (me.prettyprint.hector.api.beans.Row<String, String, String> row1 : list1) {
                                                  ...
                                                  String indcol = colfam+"_TimeIndex";
                                                    cqlQuery1.setQuery("select * from "+indcol+" ");
                                                      StringSerializer stringSerializer = StringSerializer.get();         
                                                      Keyspace keyspaceOperator = HFactory.createKeyspace(keyspace, c);
                                                      ...
                                                      if (result3 != null && result3.get() != null) {
                                                      ...
                                                      String Key;
                                                        for (Row<String, UUID, String> r : orderedRows) {
                                                            for(k=0; k<r.getColumnSlice().getColumns().size(); k++) {
                                                                ...
                                                                cqlQuery1.setQuery("select * from "+colfam+" where key ='"+Key+"'");
                                                                ...
                                                                if (result2 != null && result2.get() != null) {
                                                                    ...
                                                                    for (me.prettyprint.hector.api.beans.Row<String, String, String> row2 : list2) {
                                                                        String host = row2.getColumnSlice().getColumns().get(4).getValue();
                                                                        String component = row2.getColumnSlice().getColumns().get(1).getValue(); 
                                                                        String severity = row2.getColumnSlice().getColumns().get(5).getValue();
                                                                        String fecility = row2.getColumnSlice().getColumns().get(3).getValue();
                                                                        String tmstamp = row2.getColumnSlice().getColumns().get(6).getValue();
                                       ...
                                       String[] str1 = row.getColumnSlice().getColumns().get(1).getValue().split("-");
                                        ...
                                        .execute();
                                            ...
                                            java.util.List<me.prettyprint.hector.api.beans.Row<String, String, String>> list1 = result1.get().getList();
                                                for (me.prettyprint.hector.api.beans.Row<String, String, String> row1 : list1) {
                                                String colfam = row1.getColumnSlice().getColumns().get(1).getValue();
                                                cqlQuery1.setQuery("select * from "+colfam+""); 
                                                QueryResult<CqlRows<String, String, String>> result2 = cqlQuery1
                                                .execute();
                                                    if (result2 != null && result2.get() != null) {
                                                    java.util.List<me.prettyprint.hector.api.beans.Row<String, String, String>> list2 = result2.get().getList();
                                                        for (me.prettyprint.hector.api.beans.Row<String, String, String> row2 : list2) {
                                                                ...
                                                                String severity = row2.getColumnSlice().getColumns().get(5).getValue();
                                                                String fecility = row2.getColumnSlice().getColumns().get(3).getValue();
                                                                String timestp = row2.getColumnSlice().getColumns().get(6).getValue();
                                                                String data = row2.getColumnSlice().getColumns().get(2).getValue();
                                                                Date time=new Date(Long.parseLong(timestp));
                                                                valid = 1;
                                                                data = data.replace(",", ", ");
                                                                       %>
                                                                       <tr><td><%=keyspace%></td>
                                      ...
                                      String[] str1 = row.getColumnSlice().getColumns().get(1).getValue().split("-");
                                        ...
                                        .execute();
                                            ...
                                            java.util.List<me.prettyprint.hector.api.beans.Row<String, String, String>> list1 = result1.get().getList();
                                                ...
                                                String colfam = row1.getColumnSlice().getColumns().get(1).getValue();
                                                 cqlQuery1.setQuery("select * from "+colfam+""); 
                                                QueryResult<CqlRows<String, String, String>> check = cqlQuery1
                                                .execute();
                                                if (check != null && check.get() != null) {
                                                for (i = 0; i < slength; i++){
                                                cqlQuery1.setQuery("select * from "+colfam+" where severity = '"+sev[i]+"'"); 
                                                QueryResult<CqlRows<String, String, String>> result2 = cqlQuery1
                                                .execute();
                                                    if (result2 != null && result2.get() != null) {
                                                    java.util.List<me.prettyprint.hector.api.beans.Row<String, String, String>> list2 = result2.get().getList();
                                ...
                                for (me.prettyprint.hector.api.beans.Row<String, String, String> row : list) {
                                        ...
                                        .execute();
                                            ...
                                            java.util.List<me.prettyprint.hector.api.beans.Row<String, String, String>> list1 = result1.get().getList();
                                                ...
                                                if (check != null && check.get() != null) {
                                                for (i = 0; i < clength; i++){
                                                     String str[] = comp[i].split("_");
                                                            String h = str[0];
                                                            String com = str[1];
                                                cqlQuery1.setQuery("select * from "+colfam+" where host = '"+h+"' and component = '"+com+"'"); 
                                                QueryResult<CqlRows<String, String, String>> result2 = cqlQuery1
                                                .execute();
                                                    if (result2 != null && result2.get() != null) {
                                                    java.util.List<me.prettyprint.hector.api.beans.Row<String, String, String>> list2 = result2.get().getList();
     ...
     //////////////////////////////severity and component//////////////////////////////////////
                                            ...
                                            java.util.List<me.prettyprint.hector.api.beans.Row<String, String, String>> list1 = result1.get().getList();
                                                ...
                                                for (i = 0; i < clength; i++){
                                                     String str[] = comp[i].split("_");
                                                            String h = str[0];
                                                            String com = str[1];
                                                cqlQuery1.setQuery("select * from "+colfam+" where severity = '"+sev[j]+"' and host = '"+h+"' and component = '"+com+"'"); 
                                                QueryResult<CqlRows<String, String, String>> result2 = cqlQuery1
                                                .execute();
                                                    if (result2 != null && result2.get() != null) {
                                                    java.util.List<me.prettyprint.hector.api.beans.Row<String, String, String>> list2 = result2.get().getList();
            ...
            if (valid == 0)
                out.println("Search results not found");
